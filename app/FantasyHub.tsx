    ...
    <div className="page-content all-leagues-page">
      ...
      {!loading && scans.length > 0 && (
        <>
          ...
          <section className="portfolio-grid">
            <article className="portfolio-section panel">
              <div className="portfolio-heading"><div><span>PORTFOLIO EXPOSURE</span><h3>Concentration and correlated risk</h3></div><button type="button" className="portfolio-detail-trigger" aria-haspopup="dialog" onClick={() => setExposureOpen(true)}>{playerExposure.length} repeated</button></div>
