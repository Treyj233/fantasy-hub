...
function ProPlans({ entitlement }: { entitlement: AccountEntitlement }) {
  ...
  const proFeatures = [
    ...
    "Manager Report Card, decision ledger, and shareable performance reports",
