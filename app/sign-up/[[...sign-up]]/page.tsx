...
export default async function SignUpPage({ searchParams }: { searchParams: Promise<{ native?: string }> }) {
  ...
  const emailSignUp = <><NativeAuthIntent /><SignUp routing="path" path="/sign-up" signInUrl={nativeIos ? "/native-sign-in" : "/sign-in"} forceRedirectUrl={nativeIos ? "/native-auth-return" : "/"} appearance={nativeIos ? nativeEmailOnlyClerkAppearance : chargersClerkAppearance} /></>;
