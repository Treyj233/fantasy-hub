...
const sections = [
  ...
  },
  {
    ...
    body: [
      "Fantasy Hub is an independent fantasy-football analysis platform. Fantasy Hub is not affiliated with, endorsed by, sponsored by, or an official partner of Sleeper, ESPN, the National Football League, NFL Players Inc., the NFL Players Association, any NFL member club, or any other referenced fantasy platform, league, team, or rights holder.",
