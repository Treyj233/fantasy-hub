/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./social-agent/worker-configuration.d.ts --config social-agent/wrangler.jsonc` (hash: 74dafb137d6eaa46a37cd11b7d2c8c33)
// Runtime types generated with workerd@1.20260515.1 2026-08-19 nodejs_compat
interface __BaseEnv_Env {
	POSTING_MODE: "preview";
	POLL_INTERVAL_SECONDS: "300";
	MIN_POST_INTERVAL_MINUTES: "12";
	MAX_POSTS_PER_DAY: "20";
	GAMEDAY_MAX_POSTS_PER_DAY: "100";
	X_SOURCE_HANDLES: "RapSheet,AdamSchefter,TomPelissero,MikeGarafolo,UnderdogNFL";
	ADMIN_TOKEN: string;
	X_API_KEY: string;
	X_API_SECRET: string;
