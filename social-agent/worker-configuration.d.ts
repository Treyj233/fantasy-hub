/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./social-agent/worker-configuration.d.ts --config social-agent/wrangler.jsonc` (hash: c83f54d0ef3a93a98e3f8825718d1667)
// Runtime types generated with workerd@1.20260515.1 2026-08-19 nodejs_compat
interface __BaseEnv_Env {
	AI: Ai;
	POSTING_MODE: "live";
	POLL_INTERVAL_SECONDS: "300";
	MIN_POST_INTERVAL_MINUTES: "12";
	MAX_POSTS_PER_DAY: "20";
	GAMEDAY_MAX_POSTS_PER_DAY: "100";
	X_SOURCE_HANDLES: "RapSheet,AdamSchefter,TomPelissero,MikeGarafolo,UnderdogNFL,32BeatWriters,Schultz_Report";
	ADMIN_TOKEN: string;
	X_API_KEY: string;
	X_API_SECRET: string;
	...
	SOCIAL_AGENT: DurableObjectNamespace<import("./src/index").FantasyHubSocialAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "FantasyHubSocialAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "POSTING_MODE" | "POLL_INTERVAL_SECONDS" | "MIN_POST_INTERVAL_MINUTES" | "MAX_POSTS_PER_DAY" | "GAMEDAY_MAX_POSTS_PER_DAY" | "X_SOURCE_HANDLES" | "ADMIN_TOKEN" | "X_API_KEY" | "X_API_SECRET" | "X_ACCESS_TOKEN" | "X_ACCESS_TOKEN_SECRET" | "X_BEARER_TOKEN">> {}
}
