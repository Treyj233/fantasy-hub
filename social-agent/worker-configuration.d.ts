/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./social-agent/worker-configuration.d.ts --config social-agent/wrangler.jsonc` (hash: ed09d8c6981f0c5cf04866e7084316fa)
