/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./social-agent/worker-configuration.d.ts --config social-agent/wrangler.jsonc` (hash: 89ebd8c3a4cea01cc4ca807c650a396b)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "POSTING_MODE" | "POLL_INTERVAL_SECONDS" | "MIN_POST_INTERVAL_MINUTES" | "MAX_POSTS_PER_DAY" | "X_SOURCE_HANDLES" | "ADMIN_TOKEN" | "X_API_KEY" | "X_API_SECRET" | "X_ACCESS_TOKEN" | "X_ACCESS_TOKEN_SECRET" | "X_BEARER_TOKEN">> {}
}
