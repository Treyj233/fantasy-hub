/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./social-agent/worker-configuration.d.ts --config social-agent/wrangler.jsonc` (hash: 76b11c95679ec4117abfda27f792369d)
...
interface __BaseEnv_Env {
	...
	X_SOURCE_HANDLES: "RapSheet,AdamSchefter,TomPelissero,MikeGarafolo,UnderdogNFL,32BeatWriters";
	ADMIN_TOKEN: string;
	X_API_KEY: string;
	X_API_SECRET: string;
